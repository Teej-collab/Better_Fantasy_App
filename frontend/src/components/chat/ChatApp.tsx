...
export function ChatApp({
  ...
  return (
    <div className="relative flex h-[calc(100dvh-3.5rem)] overflow-hidden rounded-none border border-black/10 sm:h-[calc(100dvh-6rem)] sm:rounded-xl dark:border-white/10">
