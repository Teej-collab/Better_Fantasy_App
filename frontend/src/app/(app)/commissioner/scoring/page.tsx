...
export default async function CommissionerScoringPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* No page-level <h1> here — ScoringRulesSection renders its own
          <h2>Scoring Rules</h2>, and duplicating the title would just
          repeat it twice on screen (see TradeSettingsAndReview's page
